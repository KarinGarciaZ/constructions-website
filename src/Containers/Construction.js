...
class Construction extends Component {
  ...
  loadConstruction = ( id ) => {    
    ...
    .then( construction => {
      let urlImagePortrait = construction.data.images.filter( image => image.mainImage === 1 )[0].url;
  ...
  render() {
    ...
    if ( construction.images ){
      mainImage = construction.images.filter( image => image.mainImage === 1 )[0].url;
      ...
      <div className='construction'>
        ...
        { construction.images? <div className='construction__content'>
          ...
          <div className='construction__content--button'>
            <button className='btn' onClick={this.handleClick.bind( this )}>All constructions</button>
          </div>
        </div> : null}
